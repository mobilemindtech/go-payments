...
// go test -v  github.com/mobilemindtech/go-payments/tests/pagarme/v5 -run TestPagarmev5CustomerCreate
...
// go test -v  github.com/mobilemindtech/go-payments/tests/pagarme/v5 -run TestPagarmev5CustomerGet
...
// go test -v  github.com/mobilemindtech/go-payments/tests/pagarme/v5 -run TestPagarmev5CustomerList
...
// go test -v  github.com/mobilemindtech/go-payments/tests/pagarme/v5 -run TestPagarmev5CustomerUpdate
